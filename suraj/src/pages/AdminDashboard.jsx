...
const AdminDashboard = () => {
  ...
  const [sidebarOpen, setSidebarOpen] = useState(false); // Add state for sidebar toggle
    ...
    <div className="admin-dashboard">
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-12 d-md-none" style={customStyles.headerBg}>
            <div className="d-flex justify-content-between align-items-center p-3">
              <h3 style={customStyles.pinkishPurple}>Suraj Co-op</h3>
              <button 
                className="btn" 
          ...
          {/* Sidebar */}
          <nav 
            className={`col-md-3 col-lg-2 d-md-block sidebar ${sidebarOpen ? 'show' : 'd-none d-md-block'}`} 
            style={{...customStyles.headerBg, position: 'fixed', height: '100%', zIndex: 100, width: 'auto'}}
          >
                    ...
                    <button
                      onClick={() => {
                        ...
                        if (window.innerWidth < 768) {
                          setSidebarOpen(false); // Close sidebar on mobile after clicking a tab
                        }
                      }}
          ...
          {/* Main Content */}
          <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4" style={{ 
